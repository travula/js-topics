...
* Introduction
  This document lists ways to embed external web pages using
  web components. 
...
* Design 
  ...
  use web components.  The lab page becomes an external web page
  embedded into the vlabs portal.

* Implementation  
   Ways to manipulate the content of an using web
   components. 
